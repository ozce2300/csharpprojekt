...
namespace ATMMIUN
{
    public partial class MLModel1
    {
        ...
        public class ModelInput
        {
            ...
            public float IsLoanApproved { get; set; }
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"IsLoanApproved")]
            public uint IsLoanApproved { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("IsLoanApproved");
            if (labelColumn == null)
            {
                throw new Exception("IsLoanApproved column not found. Make sure the name searched for matches the name in the schema.");
            }
